...
var RTCMultiConnection = function (roomid, forceOptions) {
    ...
    function getRMCMediaElement(stream, callback, connection) {
        ...
        if (mediaElement.srcObject = stream, mediaElement.setAttribute("autoplay", !0), mediaElement.setAttribute("playsinline", !0), "Firefox" === DetectRTC.browser.name) {
